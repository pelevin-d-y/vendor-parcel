...
var select = document.querySelector('.login-select');
...
if (conditions) {
  var _select = document.querySelector('.conditions__select');
  ...
  Array.from(_select.options).forEach(function (option) {
...
//# sourceMappingURL=js.298ba4ae.js.map